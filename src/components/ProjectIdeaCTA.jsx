...
const ProjectIdeaCTA = () => {
  ...
  return (
    <section
      ref={ref}
      className="py-24 bg-gradient-to-br from-purple-600 via-purple-700 to-pink-600 relative overflow-hidden"
    >
      {/* Background Elements */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-xl text-white/90 mb-12 max-w-2xl mx-auto leading-relaxed">
            ...
            turn your vision into powerful digital reality that drives results.
          </p>
