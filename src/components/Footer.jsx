        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed max-w-md">
              Transforming businesses through innovative digital solutions, strategic marketing, 
              and cutting-edge technology that drives measurable results.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-300">gomdigitalconsultancy@gmail.com</span>
              </li>
              <li className="flex items-start space-x-3">
                <MapPin className="w-5 h-5 text-purple-400 mt-1 flex-shrink-0" />
                <span className="text-gray-300">
                  200 Elm Street, Toronto<br />
