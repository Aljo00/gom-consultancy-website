        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div className="text-gray-800 text-lg leading-relaxed font-medium space-y-6">
            ...
            <p>
              ...
              things out. My first YouTube channel in India had no team, no
              tools, and no stable internet just deep curiosity and hunger to
              grow.
            </p>
            <p>
            ...
            <p>
              ...
              started with: no shortcuts, no inflated promises. Just real
